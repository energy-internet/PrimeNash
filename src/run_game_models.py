...
def get_prompts(game_type):
    if game_type == 'carbonmkt': 
        return {
            ...
            # 'extract_score': carbonmkt_extract_score
        }
...
if __name__ == "__main__":
    ...
    main(game_type='gender', num_simulations=8, sr_runs=1)
    
    # # Test Hawk-Dove model
    # print("\nTesting Hawk-Dove model...")
    # main(game_type='hawkdove', num_simulations=8, sr_runs=1)
    
    # Test Cournot model
    # print("Testing Cournot model...")
    # main(game_type='cournot', num_simulations=8, sr_runs=1)
    
    # Test FPSBA model
    # print("\nTesting FPSBA model...")
    # main(game_type='fpsba', num_simulations=8, sr_runs=1)
    
    # Test Stackelberg model
    # print("\nTesting Stackelberg model...")
    # main(game_type='stackelberg', num_simulations=8, sr_runs=1)
    
    # # Add Market model test
    # print("\nTesting Market model...")
    # main(game_type='market', num_simulations=8, sr_runs=1)
    
    # Test Signaling model
    # print("\nTesting Signaling model...")
    # main(game_type='signaling', num_simulations=3, sr_runs=1)
    
    # Test Carbon Market model
    # print("\nTesting Carbon Market model...")
    # main(game_type='carbonmkt', num_simulations=8, sr_runs=1)